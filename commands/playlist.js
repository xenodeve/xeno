...
module.exports = {
name: "playlist",
description: "ให้คุณจัดการคำสั่งเพลย์ลิสต์.",
options: [
{
name: "create",
description: "สร้าง playlist.",
...
{
name: "public",
description: "ทำให้เพลย์ลิสต์เป็นสาธารณะ. (true=public playlist, false=private playlist)",
...
{
name: "name",
description: "ชื่อ playlist ที่ต้องการจะลบ.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "playlist-name",
description: "ชื่อ playlist.",
type: ApplicationCommandOptionType.String,
required: true
},
{
name: "name",
description: "ชื่อเพลงหรือลิ้งค์เพลง.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "list",
description: "เรียกดูเพลงในเพลย์ลิสต์.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
...
{
name: "lists",
description: "เรียกดูเพลย์ลิสต์ทั้งหมดของคุณ.",
type: ApplicationCommandOptionType.Subcommand,
options: []
},
{
name: "top",
description: "เพลย์ลิสต์ยอดนิยม.",
type: ApplicationCommandOptionType.Subcommand,
options: []
}
...
.setFooter({ text: `XenoDev & THZ Team` })
